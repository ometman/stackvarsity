      ...
      <section>
          <div className="flex p-4 bg-gray-100 items-center justify-between">
            <h1 className="flex text-2xl  font-bold text-gray-700">
              <p className="text-1xl">Welcome {isUser?.email}!</p>
            </h1>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-6">
            ...
            <Link href="/dashboard/student/grades" className="bg-green-100 text-green-700 p-4 rounded shadow-md text-center">
              Grades
            </Link>
          ...
          <div className="mb-6">
            ...
            <button 
              className="bg-blue-600 h-12 text-white rounded-md py-2 px-6 shadow-md hover:bg-blue-700 transition"
